...
from selenium_uc.webdriver.remote.webelement import WebElement
...
class EventFiringWebDriver:
    ...
    def __init__(self, driver: WebDriver, event_listener: AbstractEventListener) -> None:
        ...
        ::
            ...
            from selenium_uc.webdriver import Firefox
            from selenium_uc.webdriver.support.events import EventFiringWebDriver, AbstractEventListener
